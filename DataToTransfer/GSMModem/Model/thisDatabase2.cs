...
namespace GSMModem
{
    ...
    {
        public static String server = System.IO.File.ReadAllText(thisDatabase.driveloc + thisDatabase.comp_folder + "\\Publish\\serverDatabase.txt"); //
       // public static String server = "localhost" /*System.IO.File.ReadAllText(thisDatabase.driveloc + thisDatabase.comp_folder + "\\Publish\\serverDatabase.txt")*/;
        ...
        //public static String lcl_db = "inv_balai_sucat";
        public static String lcl_db = System.IO.File.ReadAllText(thisDatabase.driveloc + thisDatabase.comp_folder + "\\Publish\\serverDBname.txt");
