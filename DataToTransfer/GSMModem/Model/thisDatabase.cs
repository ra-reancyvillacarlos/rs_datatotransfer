...
namespace GSMModem
{
    public class thisDatabase
    {
        ...
        public static String driveloc = "\\\\RIGHTAPPS\\RightApps\\";// "\\\\RA-PAUL\\RightApps\\"; //"\\\\RA-PAUL\\RightApps\\";
        public static String comp_folder = "BALAI";//
        public static String lcl_db = "inv_balai_062518";// inv_balai_ahsi080117 inv_balai_051018 inv_latest_dec
        public static String svr_pass = "Rightech777";//"Rcaightech777"; 
        string cipher = "", mac_add = "", decipher = "";
        public static String schema_static = "rssys";//"rssys";
        ...
        public Boolean InsertSelect(String table, String table2, String cond)
        {
            Boolean flag = false;
            ...
            try
            {
                ...
                string SQL = "INSERT INTO " + this.schema + "." + table + " SELECT * FROM " + this.schema + "." + table2 + " WHERE " + cond + "";
                //MessageBox.Show(SQL);
                NpgsqlCommand command = new NpgsqlCommand(SQL, conn);
        ...
        public void write_log(String messg)
        {
            String loc_db = this.get_system_loc();

            String path = @"" + loc_db + "\\BALAI\\Logs";
        ...
        public void proc_exe(String path, String messg)
        {
            using (System.IO.StreamWriter file =
            new System.IO.StreamWriter(@"" + path + "\\dataToTransfer_" + DateTime.Now.ToString("yyyy_MM_dd_hh_mm_tt") + ".txt", true))
            {
